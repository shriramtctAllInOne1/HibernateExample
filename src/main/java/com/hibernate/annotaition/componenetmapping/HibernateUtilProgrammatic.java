...
public class HibernateUtilProgrammatic {
	...
	private static SessionFactory buildSessionFactory() {
		...
		try {
			Configuration configuration= new Configuration().addAnnotatedClass( com.hibernate.annotaition.componenetmapping.Employee.class).
					addAnnotatedClass( com.hibernate.annotaition.componenetmapping.Address.class)
